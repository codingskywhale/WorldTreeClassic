...
public class SaveDataManager
{
    ...
    public IEnumerator LoadGameDataCoroutine(List<Skill> skillList, List<Artifact> artifactList, WorldTree worldTree)
    {
        ...
        PlayFabManager.Instance.LoadGameData(gameData =>
        {
            if (gameData == null)
            {
                ...
                BigInteger bigNumber = BigInteger.Parse("500000");
    ...
    public void ApplyLoadedGameData(GameData gameData, List<Skill> skillList, List<Artifact> artifactList, WorldTree worldTree)
    {
        ...
        DataManager.Instance.animalGenerateData.SetGenerationCountByLoadedData(gameData);

        if (gameData.animalData != null)
        {
            DataManager.Instance.animalGenerateData.SetCreateCostByLoadedData(gameData);
        ...
        {
            DataManager.Instance.touchData.SetTouchInfoByLoadedData(gameData);
        }
    ...
    public void InitializeDefaultGameData()
    {
        ...
        DataManager.Instance.animalGenerateData.SetGenerationCountByLoadedData(null);
        DataManager.Instance.touchData.SetTouchInfoByLoadedData(null);
