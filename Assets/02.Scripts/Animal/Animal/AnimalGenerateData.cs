...
public class AnimalGenerateData
{
    ...
    public void SetGenerationCountByLoadedData(GameData gameData)
    {
        if (gameData != null)
        {
            nowAnimalCount = gameData.animalData.nowAnimalCount;
            maxAnimalCount = gameData.animalData.maxAnimalCount;
    ...
    public void SetCreateCostByLoadedData(GameData gameData)
    {
        nowCreateCost = string.IsNullOrEmpty(gameData.animalData.nowCreateCost) ? BigInteger.Zero : BigInteger.Parse(gameData.animalData.nowCreateCost);
    }
}
